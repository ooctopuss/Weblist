 ...
 */
@MultipartConfig
public class AggProd extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        prodottoDao.insertProdotto(new Prodotto(nome,note,idCategP,idLogo));
        caricaMultImm(request,immaginiDao,prodottoDao.getId(idLogo).getId());
        
        response.sendRedirect(request.getContextPath() + "/pages/Prodotto.jsp");
