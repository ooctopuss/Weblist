 ...
 */
@MultipartConfig
public class ModCatLServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int idTypes = Integer.parseInt(request.getParameter("nomeM"));
        ...
        catLDao.updateCategoriaLista(new CategoriaLista(id,t.getNomeIt(),descrizione,idTypes));
